    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
          'CREATE TABLE IF NOT EXISTS `article` (`id` INTEGER, `author` TEXT, `title` TEXT, `description` TEXT, `url` TEXT, `urlToImage` TEXT, `publishAt` TEXT, `content` TEXT, PRIMARY KEY (`id`))',
        );
...
class _$ArticleDao extends ArticleDao {
  ...
  @override
  Future<void> insertArticle(ArticleModel model) async {
    await _articleModelInsertionAdapter.insert(model, OnConflictStrategy.abort);
  }

  @override
  Future<void> deleteArticle(ArticleModel model) async {
    await _articleModelDeletionAdapter.delete(model);
  }
}
